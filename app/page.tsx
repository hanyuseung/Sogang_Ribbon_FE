  ...
  return (
    <>
      <section className="px-[18px] pt-7 pb-8">
        ...
        <Link href="/award" className="block mt-[10px]">
          <div className="mx-2 my-4 p-[22px] rounded-[28px] bg-gradient-to-br from-[#ffd6e5] to-white shadow-[0_18px_40px_rgba(214,51,108,0.10)] border border-[#f5e4a0]">
            <span className="inline-block text-[#d6336c] text-[13px] font-black mb-2">🏆 AWARD</span>
            <h3 className="text-2xl font-bold mb-2">서강리본 어워드</h3>
            <p className="text-[#765260] text-sm">년도별 베스트 맛집 결과를 확인해보세요</p>
          </div>
        </Link>
